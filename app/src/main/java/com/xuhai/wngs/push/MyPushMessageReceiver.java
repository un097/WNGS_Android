...
public class MyPushMessageReceiver extends FrontiaPushMessageReceiver {
	...
	public void onBind(Context context, int errorCode, String appid, 
		...
		Log.d(TAG, responseString);
         SharedPreferences.Editor editor = context.getSharedPreferences("spn_wngs", Activity.MODE_PRIVATE).edit();

		try {
			editor.putString( "userid", AESEncryptor.encrypt(userId));
			editor.putString( "channelid", AESEncryptor.encrypt(channelId));
			editor.commit();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void onNotificationClicked(Context context, String title, 
		...
		if (customContentString != null) {
			...
			try {
				customJson = new JSONObject(customContentString);
				String myvalue = null;
//				if (customJson.isNull("ccurl")) {
//					myvalue = customJson.getString("ccurl");
//
//
//				}
                if (customJson.has("url_diy")) {
                    myvalue = customJson.getString("url_diy");
                    Log.d(TAG, "myvalue === " + myvalue);
                }

                startWebContent(context, title, myvalue);
...
//		updateContent(context, responseString);
    ...
    private void startWebContent(Context context, String title, String url) {
        Log.d(TAG, "startWebContent ----------- >>>>>> ");
