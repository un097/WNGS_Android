 ...
 */
public class BLDhotAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<ShzlBldHotBean> mlist;

    public BLDhotAdapter(Context context, ArrayList<ShzlBldHotBean> bldhotList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_gv_wyfw_bld_hot, parent, false);
        ...
        holder.text.setText(mlist.get(position).getGoods());
        holder.price.setText(context.getResources().getString(R.string.yang) + " " + mlist.get(position).getPrice());
