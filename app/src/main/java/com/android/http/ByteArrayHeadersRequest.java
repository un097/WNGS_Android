 ...
 * 
 */
class ByteArrayHeadersRequest extends Request<byte[]> {
	...
	public ByteArrayHeadersRequest(int method, String url, Object postBody, Listener<byte[]> listener, ErrorListener errorListener) {
